  ...
  return `
    <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
      ...
      <ul style="padding-left: 20px; margin: 8px 0 24px 0;">
        ...
        <li style="margin-bottom: 6px;"><a href="https://inspectagents.com/checklist/" style="color: #059669; text-decoration: none; font-weight: 500;">63-Point Safety Checklist</a> — printable checklist aligned with OWASP Top 10</li>
