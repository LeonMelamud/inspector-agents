...
const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    example: 'Frontier labs like OpenAI and Anthropic engage external red teamers before every major model release (GPT-5, Claude Opus) to find jailbreaks, bias issues, and security vulnerabilities.',
  ...
  },
  {
    ...
    example: 'Modern frontier models offer context windows from 200K up to 1M+ tokens — enough to process entire codebases or books at once.',
